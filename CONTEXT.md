...
- ghosttykitd: The GhosttyKit daemon. It is the one that actually owns the AppleScript interactions with Ghostty proper, along with associated helpers such as file paste support.
